...
export const Route = createFileRoute('/_authenticated/help-center/tickets')({
  component: TicketCentrePage,
})
  ...
  return (
    <div className='space-y-6'>
      <div className='flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between'>
        <div>
          <h1 className='text-2xl font-semibold text-slate-900'>Ticket Centre</h1>
          <p className='text-sm text-muted-foreground'>
            {isVendor ? 'Raise support tickets to get help.' : 'Manage and respond to support tickets from vendors.'}
          </p>
        </div>
