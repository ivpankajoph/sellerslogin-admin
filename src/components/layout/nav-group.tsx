...
const ICON_ACCENTS = [
  { chip: 'bg-rose-100 dark:bg-rose-500/25', icon: 'text-rose-600 dark:text-rose-300' },
  { chip: 'bg-orange-100 dark:bg-orange-500/25', icon: 'text-orange-600 dark:text-orange-300' },
  { chip: 'bg-amber-100 dark:bg-amber-500/25', icon: 'text-amber-700 dark:text-amber-300' },
  { chip: 'bg-emerald-100 dark:bg-emerald-500/25', icon: 'text-emerald-600 dark:text-emerald-300' },
  { chip: 'bg-teal-100 dark:bg-teal-500/25', icon: 'text-teal-600 dark:text-teal-300' },
  { chip: 'bg-sky-100 dark:bg-sky-500/25', icon: 'text-sky-600 dark:text-sky-300' },
  { chip: 'bg-indigo-100 dark:bg-indigo-500/25', icon: 'text-indigo-600 dark:text-indigo-300' },
  { chip: 'bg-violet-100 dark:bg-violet-500/25', icon: 'text-violet-600 dark:text-violet-300' },
  { chip: 'bg-fuchsia-100 dark:bg-fuchsia-500/25', icon: 'text-fuchsia-600 dark:text-fuchsia-300' },
]
